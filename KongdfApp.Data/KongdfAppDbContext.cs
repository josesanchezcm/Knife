...
using KongdfApp.Data.Configurations;
using Microsoft.AspNet.Identity.EntityFramework;

namespace KongdfApp.Data
{
	public class KongdfAppDbContext : IdentityDbContext<ApplicationUser>, IDbContext
	{
		...
		protected override void OnModelCreating(DbModelBuilder modelBuilder) {
			...
			modelBuilder.Configurations.Add(new ColleagueConfiguration());
